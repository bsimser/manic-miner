 ...
 * =============================================================
   ...
   0.10x  16-05-2011  Alejandro Guillen: 
                        Imagenes de los enemigos y seguir añadiendolos
...
namespace minerXNA
{
    public class Nivel12 : Nivel
    {
            ...
            : base(c)
        {
            ...
            listaEnemigos[0] = new Enemigo("enemBarril", c);
            ...
            listaEnemigos[1] = new Enemigo("enemBarril", c);
            ...
            listaEnemigos[2] = new Enemigo("enemBarril", c);
